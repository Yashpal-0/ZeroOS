...
def _sandbox_check(name: str, arguments: dict) -> bool:
    """True if every sandboxed argument of this call resolves inside the sandbox."""
...
class Gate:
    ...
    def prepare(self, calls: list[tuple[str, dict]]) -> None:
        ...
        for name, arguments in calls:
            try:
                ...
                continue
            if not _sandbox_check(name, arguments):
                self._ledger[_key(name, arguments)].append(Verdict.REFUSE)
                continue
        ...
        rows = describe.group_batch(pending)
    ...
    def decide(self, name: str, arguments: dict) -> tuple[Verdict, str]:
        ...
        answers = self._ask(describe.describe_batch([(name, arguments)]))
